...
export default function PushControls() {
  ...
  async function handleSubscribe() {
    ...
    } catch (e) { setStatus(e.message || "Feil"); }
  }

  async function handleTest() {
    try { await sendTestPush(); setStatus("Test sendt"); }
    catch(e){ setStatus(e.message || "Feil"); }
  }

  async function handleUnsub() {
    try { await unsubscribeFromPush(); setStatus("Deaktivert"); }
    catch(e){ setStatus(e.message || "Feil"); }
  }

  return (
    <div style={{display:"grid", gap:8, padding:12, border:"1px solid #e5e7eb", borderRadius:12}}>
